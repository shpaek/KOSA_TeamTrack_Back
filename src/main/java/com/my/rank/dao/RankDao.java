...
public interface RankDAO {
	 ...
	 */
	List<RankDTO> selectByMonth(int teamNo, Date rankDate) throws FindException;
	 ...
	 */
	void insert(int teamNo, RankDTO rankDto) throws AddException;
	 ...
	 */
	List<AttendanceDTO> selectAttendanceDay(int teamNo, Date attendanceDate) throws FindException;
	 ...
	 */
	List<TaskDTO> countMonthlyTask(int teamNo, Date endDate) throws FindException;
	 ...
	 */
	List<MemberScoreDTO> selectTaskScore(int teamNo, Date submitDate) throws FindException;
	 ...
	 */
	List<TaskDTO> selectReviewScore(int teamNo, Date endDate) throws FindException;
	 ...
	 */
	List<QnACommentDTO> selectQnAScore(int teamNo, Date pickedDate) throws FindException;
